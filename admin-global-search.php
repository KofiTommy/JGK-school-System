...
function ags_tool_overrides(){
    return array(
        ...
        'stores_management' => array('href' => 'storekeeper-dashboard.php', 'icon' => 'fa-archive', 'keywords' => 'storekeeper stores stock receipt issue inventory food provisions balance textbooks books uniforms bedding student items returns'),
        'matron_management' => array('href' => 'matron-dashboard.php', 'icon' => 'fa-cutlery', 'keywords' => 'matron food kitchen weekly menu meal planner dining requisition store request boarders welfare hostel dormitory house supervision student welfare'),
