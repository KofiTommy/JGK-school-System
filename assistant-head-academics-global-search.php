...
function ags_tool_catalog(){
    return array(
        ...
        array('module' => 'stores_management', 'href' => 'storekeeper-dashboard.php', 'label' => 'Storekeeper Dashboard', 'icon' => 'fa-archive', 'description' => 'Open the school store dashboard.', 'keywords' => 'storekeeper stores stock receipt issue inventory student items books uniforms bedding'),
        array('module' => 'matron_management', 'href' => 'matron-dashboard.php', 'label' => 'Matron Dashboard', 'icon' => 'fa-cutlery', 'description' => 'Open the matron kitchen and menu dashboard.', 'keywords' => 'matron kitchen menu food requisition boarders welfare'),
